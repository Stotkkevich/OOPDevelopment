...
public class AppRunnerCollections {
	...
	public static void main(String[] args) {
		...
		logger.info("Shape " + maxShape.getClass().getSimpleName() + " has maximal area " + maxShape.getArea());

		logger.info("Shape " + minShape.getClass().getSimpleName() + " has minimal area " + minShape.getArea());
